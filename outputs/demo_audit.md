...
- missing_event: 0
### cytogenetics
- path: data/demo/cytogenetics.csv
- n_rows: 260
- n_patients: 260
- patient_overlap_with_clinical: 260
- subtype_cols: ['amp1q', 'del1p', 'del13q', 'del17p', 't_4_14', 't_11_14', 'hyperdiploid']
- subtype_counts: {'amp1q': {'n': 90, 'events': 73}, 'del1p': {'n': 39, 'events': 31}, 'del13q': {'n': 101, 'events': 77}, 'del17p': {'n': 30, 'events': 25}, 't_4_14': {'n': 33, 'events': 27}, 't_11_14': {'n': 43, 'events': 31}, 'hyperdiploid': {'n': 116, 'events': 74}}
### omics
- path: data/demo/omics.csv
- n_rows: 260
- patient_overlap_with_clinical: 260
- n_numeric_feature_columns_sampled: 120
